...
<?= form_open_multipart('penugasan/tambah', ['id' => 'form', 'class' => 'form-horizontal']) ?>
 	<div class="col-xs-12">
    	<div class="card">
	        <div class="card-header">
	           <i class="fa fa-align-justify"></i> Tambah Data Penugasan Pegawai
	        </div>
	        <div class="card-block">
	        	...
	        	<div class="form-group">
	        		...
	        		<input type="text" name="tanggal_awal_masa_penugasan" class="form-control datepicker" placeholder="Tanggal Awal Masa Penugasan" required readonly>
	        	</div>
	        	<div class="form-group">
	        		<label for="lokasi_penugasan">Lokasi Penugasan<span class="required">*</span></label>
	        		<input type="text" name="lokasi_penugasan" placeholder="Lokasi Penugasan" class="form-control" required>
	        	</div>
	        	<div class="form-group">
	        		<label for="lama_penugasan">Lama Penugasan<span class="required">*</span></label>
	        		<input type="text" name="lama_penugasan" placeholder="Lama Penugasan" class="form-control" required>
	        	</div>
	        	<div class="form-group">
