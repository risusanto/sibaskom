...
class List_field extends MY_Controller {
	...
	function index()
	{
		...
		$data['form_action']	= site_url('diklat/list_field/ExcelDataAdd');
	...
	{ 
        ...
        for($i=2;$i<=$totalrows;$i++)
        {
			...
			$no_sertifikat		=$objWorksheet->getCellByColumnAndRow(5,$i)->getValue();
			$judul_diklat			=$objWorksheet->getCellByColumnAndRow(6,$i)->getValue();
			$lembaga_penyelengara			=$objWorksheet->getCellByColumnAndRow(7,$i)->getValue();
			$waktu_alert			=$objWorksheet->getCellByColumnAndRow(8,$i)->getValue();
			...
			$data=array('nip'=> $nip, 
						...
						'lembaga_penyelengara'=> $lembaga_penyelengara,
