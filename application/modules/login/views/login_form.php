        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card-group">
                    <div class="card p-2">
                    	<form action="<?= base_url() ?>index.php/login/validate_credentials" method="post">
                            <div class="card-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 text-xs-right">
                                        <a href="<?= base_url() ?>index.php/login/forgetpassword" class="btn btn-link px-0">Forgot password?</a>
                                    </div>
                                </div>
                            </div>
                        </form>
