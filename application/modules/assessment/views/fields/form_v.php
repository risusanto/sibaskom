...
<?= form_open_multipart('assessment/tambah', ['id' => 'form', 'class' => 'form-horizontal']) ?>
 	<div class="col-xs-12">
    	<div class="card">
	        <div class="card-header">
	           <i class="fa fa-align-justify"></i> Tambah Data Assessment
	        </div>
	        <div class="card-block">
	        	...
	        	<div class="form-group">
	        		...
	        		<input type="text" name="hasil_assesment" placeholder="Hasil Assessment" class="form-control" required>
	        	</div>
	        	<div class="form-group">
	        		<label for="rekomendasi">Rekomendasi<span class="required">*</span></label>
	        		<input type="text" name="rekomendasi" placeholder="Rekomendasi" class="form-control" required>
	        	</div>
	        	<div class="form-group">
		    ...
		    <div class="card-footer">
	            <button type="submit" name="submit" value="Submit" class="btn btn-sm btn-primary"><i class="fa fa-dot-circle-o"></i> Submit</button>
